  ...
  if (outputChoice === '5') {
    ...
    if (modes.social) {
      ...
      const headers = [
        ...
        { id: 'facebookProfiles', title: 'Facebook Profiles' },
        { id: 'instagramProfiles', title: 'Instagram Profiles' },
        { id: 'youtubeProfiles', title: 'Youtube Profiles' },
        { id: 'tiktokProfiles', title: 'Tiktok Profiles' },
        { id: 'twitterProfiles', title: 'Twitter Profiles' },
      ];
